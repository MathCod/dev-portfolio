...
const Contact = () => {
  return (
    <section id="contact" className="py-32 px-6 md:px-20 bg-white/5">
      <div className="max-w-7xl mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl md:text-8xl font-syne font-extrabold mb-12 uppercase leading-none">
            UN PROJET ?<br />
            <span className="text-neon-purple">DISCUTONS-EN.</span>
          </h2>

          <div className="flex flex-col items-center gap-8">
            <a 
              href="mailto:ton-email@exemple.com" 
              className="text-xl md:text-3xl font-mono hover:text-neon-purple transition-colors border-b border-white/10 pb-2"
            >
